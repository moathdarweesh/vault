...
const I18N = {
  en: {
    ...
    fl_repeat_title: "Repeat yesterday", fl_repeat_sub: 'Pick what you ate again',
    ...
    servings: 'Servings',
    fl_edit_title: 'Edit entry', fl_src_label: 'from the label', fl_src_estimate: 'estimate',
  ...
  ar: {
    ...
    fl_repeat_title: 'كرّر أمس', fl_repeat_sub: 'اختر ما أكلته مرّةً أخرى',
    ...
    servings: 'عدد الحصص',
    fl_edit_title: 'تعديل السطر', fl_src_label: 'من الملصق', fl_src_estimate: 'تقدير',
