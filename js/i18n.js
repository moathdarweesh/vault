...
const I18N = {
  en: {
    ...
    back_title: 'Your plan is where you left it', back_sub: '{n} days since your last session',
  ...
  ar: {
    ...
    ai_error: 'صار خطأ',
    ai_err_service: 'تعذّر الوصول إلى خدمة الذكاء الآن — الخلل عندنا لا عندك، وأكلك المحفوظ يعمل كالمعتاد.',
    ...
    tmpl_name_full_body: 'الجسم كامل', tmpl_name_bro_split: 'كمال الأجسام',
    ...
    back_title: 'خطّتك محفوظة كما تركتها', back_sub: 'مضى {n} يومًا منذ آخر جلسة',
