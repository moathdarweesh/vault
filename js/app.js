...
const EXERCISE_VARIATIONS = {
  ...
  'Shrugs': ['Cable Shrug'],
  'Barbell Curl': ['Dumbbell Curl', 'Hammer Curl', 'Preacher Curl Machine', 'Cable Curl'],
  'Dumbbell Curl': ['Barbell Curl', 'Hammer Curl', 'Preacher Curl Machine'],
  'Preacher Curl Machine': ['Barbell Curl', 'Dumbbell Curl', 'Cable Curl'],
